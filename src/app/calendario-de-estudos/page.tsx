...
export default async function StudyCalendarPage({
  ...
  const [events, personalActivities, workSchedule, simulationDate, studentContext] =
    await Promise.all([
    ...
    buildVitruStudentContext(activeUserId),
  ]);
  ...
  return (
    <AppShell activeUserId={activeUserId}>
      ...
      <StudyPlannerView
        ...
        subjects={subjects}
        planningDate={today}
        availableStudySlots={studentContext.schedule.availableStudySlots}
      />
    </AppShell>
  );
}
