    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4 p-4 md:gap-6 md:p-6 lg:flex-row">
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl bg-bg-card">
          {/* Texto e vídeo convivem: o conteúdo em markdown é o que alimenta a
              marcação de parágrafo e o scoreOverlap do nudge de questão errada,
              então nunca pode ser substituído pelo player. */}
