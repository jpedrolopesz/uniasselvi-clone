      ...
      >
        {MENU_ITEMS.map((label) => (
          <button
            ...
            className="shrink-0 cursor-not-allowed whitespace-nowrap rounded-full px-4 py-2 text-sm font-medium text-text-secondary/80 transition hover:bg-bg-card-hover hover:text-text-primary"
          >
            {label}
          </button>
        ))}
